    ...
    public class TouchController : MonoBehaviour
    {
        ...
        public void SetInsertionType(string type)
        {
            switch (type)
            {
                ...
                //case Tags.Home1             : _behaviour = new HomeBehaviour(HomeBuilding.Home1); break;
                //case Tags.Home2             : _behaviour = new HomeBehaviour(HomeBuilding.Home2); break;
